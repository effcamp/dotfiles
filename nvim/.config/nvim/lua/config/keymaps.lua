...
vim.keymap.set("n", "K", "i<CR><ESC>==", { desc = "Split lines and indent" })
...
-- Page up/down
vim.keymap.set("i", "<PageUp>", "<Esc><C-u>", { desc = "Exit insert and page up", noremap = true })
vim.keymap.set("i", "<PageDown>", "<Esc><C-d>", { desc = "Exit insert and page down", noremap = true })
...
-- Arrow keys
vim.keymap.set("i", "<Up>", "<Esc><Up>", { desc = "Exit insert and move up" })
vim.keymap.set("i", "<Down>", "<Esc><Down>", { desc = "Exit insert and move down" })
...
vim.keymap.set({ "n", "i", "v" }, "<C-PageUp>", "<Cmd>BufferLineCyclePrev<CR>", { silent = true })
vim.keymap.set({ "n", "i", "v" }, "<C-PageDown>", "<Cmd>BufferLineCycleNext<CR>", { silent = true })

vim.keymap.set("n", "<leader>va", "ggVG", { noremap = true, desc = "Select all text" })
